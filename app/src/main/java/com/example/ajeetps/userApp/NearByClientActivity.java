 ...
 */
public class NearByClientActivity extends CommonUtil implements GoogleApiClient.ConnectionCallbacks,
    ...
    private static final String TAG = NearByClientActivity.class.getSimpleName();
...
//    private EditText mMessageText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nearby_client_activity_main);
...
//        mMessageText = (EditText) findViewById(R.id.edittext_message);
    ...
    private void startDiscovery() {
        ...
        Log.i(TAG, "Kishore: Connected to wifi network");
                ...
                .setResultCallback(new ResultCallback<Status>() {
                    ...
                    public void onResult(Status status) {
                        if (status.isSuccess()) {
                            ...
                            updateViewVisibility(CommonUtil.STATE_DISCOVERING);
                        } else {
                            ...
                            if (statusCode == ConnectionsStatusCodes.STATUS_ALREADY_DISCOVERING) {
                                ...
                                updateViewVisibility(CommonUtil.STATE_READY);
                            }
                        }
                    }
                });
                ...
                .setPositiveButton("Connect", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Nearby.Connections.acceptConnectionRequest(mGoogleApiClient, endpointId,
                                payload, NearByClientActivity.this)
                                .setResultCallback(new ResultCallback<Status>() {
                                    @Override
                                    public void onResult(Status status) {
                                        if (status.isSuccess()) {
                ...
                new Connections.ConnectionResponseCallback() {
                    ...
                    public void onConnectionResponse(String endpointId, Status status,
                        ...
                        if (status.isSuccess()) {
                            ...
                            Toast.makeText(NearByClientActivity.this, "Connected to " + endpointName,
    ...
    public void onEndpointFound(final String endpointId, String deviceId, String serviceId,
        ...
        Log.d(TAG, "Kishore: onEndpointFound:" + endpointId + ":" + endpointName);
        ...
        if (mMyListDialog == null) {
            ...
            mMyListDialog = new MyListDialog(this, builder, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    NearByClientActivity.this.connectTo(selectedEndpointId, selectedEndpointName);
                    mMyListDialog.dismiss();
                }
            });
        }
    ...
    public void onConnectionSuspended(int i) {
        ...
        updateViewVisibility(CommonUtil.STATE_IDLE);
